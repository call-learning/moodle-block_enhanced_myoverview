...
$functions = array(
    'block_enhanced_myoverview_get_enrolled_courses_by_timeline_classification' => array(
        'classname' => 'block_enhanced_myoverview\external',
        ...
        Filter course by role on the course',
        'type' => 'read',
        'ajax' => true,
